...
function initMap() {
  ...
  var link = 'https://www.mibici.net/site/assets/files/1198/datos_abiertos_2017_12.csv';
  ...
  var icons = {
          parking: {
            estacion: 'https://www.mibici.net/site/templates/static/455375-1515453811/images/devuelve-icon.svg'
					}
   };
   Console.log('Hola');
   var csv_file = $.csv.toObjects(link);
